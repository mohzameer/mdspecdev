-- Allow public read access to comment threads if the spec is public
...
-- Allow public read access to comments if the spec is public
...
-- Update threads_update policy to allow 'member' role to resolve threads (not just admin/owner)
...
-- Update get_spec_by_slugs to return user_role
