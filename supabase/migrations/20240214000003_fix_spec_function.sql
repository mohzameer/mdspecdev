...
-- Function to get spec by slugs, allowing public access if is_public is true OR user is owner
...
GRANT EXECUTE ON FUNCTION get_spec_by_slugs TO anon, authenticated, service_role;
